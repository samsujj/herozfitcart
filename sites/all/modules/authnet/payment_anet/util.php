...
function send_xml_request($g_apihost,$g_apipath,$content)
{
...
function MerchantAuthenticationBlock($g_loginname,$g_transactionkey) {


	//global $g_loginname, $g_transactionkey;

    //echo $g_loginname;echo $g_transactionkey;
    //exit;
	return
